...
public class Charizard extends Pokemon {
    public Charizard(String nombre) {
        super(nombre, Tipo.FUEGO, Tipo.VOLADOR, 360, 293, 280, 348, 
        295, 328);
        ListaMovimientos listaMovimientos = new ListaMovimientos();
        setMovimiento(0, listaMovimientos.buscarMovimientoPorNombre("Tajo aereo"));
        setMovimiento(1, listaMovimientos.buscarMovimientoPorNombre("Giro fuego"));
        setMovimiento(2, listaMovimientos.buscarMovimientoPorNombre("Colmillo igneo"));
    ...
    public double calcularEfectividad(Tipo tipo) {
        ...
        switch (tipo) {
            case ACERO: case FUEGO: case HADA: case LUCHA: efectividad *= 0.5; break;
            case AGUA: case ELECTRICO: efectividad *= 2; break;
            case BICHO: case PLANTA: efectividad *= 0.25; break;
            case ROCA: efectividad *= 4; break;
            case TIERRA: efectividad *= 0; break;
        }
        return efectividad;
    }
