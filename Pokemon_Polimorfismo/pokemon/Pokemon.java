...
public abstract class Pokemon implements PokemonInterface {
    ...
    public Pokemon(String nombre, Tipo tipo, Tipo tipo2, int hp, int puntosAtaque, int puntosDefensa, int puntosAtaqueEspecial, 
    int puntosDefensaEspecial, int velocidad) {
        this.nombre = nombre;
        this.tipo = tipo;
        this.tipo2 = tipo2;
        this.nivel = 100;
    ...
    @Override public boolean seHaConcretadoAtaque(Pokemon pokemon, Movimientos ataque) {
    ...
    public void atacar(int a, Pokemon pokemon) {
        ...
        if (seHaConcretadoAtaque) this.getMovimiento(a).setPuntosPoder(ataque.getPuntosPoder() - 1);
        
    }

    public void setMovimiento(int indice, Movimientos movimientos) { this.movimientos[indice] = movimientos; }
    public Movimientos getMovimiento(int indice) { return movimientos[indice]; }
    public int getPuntosAtaque() { return puntosAtaque; }
    public int getPuntosDefensa() { return puntosDefensa; }
    public int getPuntosAtaqueEspecial() { return puntosAtaqueEspecial; }
    public int getPuntosDefensaEspecial() { return puntosDefensaEspecial; }
    public  int getVariacion() { return variacion; }
    public int getVelocidad() { return velocidad; }

    @Override public double obtenerBonificacion(Pokemon pokemon, Movimientos movimiento) {
